...
struct LoginScreen: View {
    ...
    var body: some View {
        NavigationStack {
            VStack {                // <-- VStack containing LoginScreen content
                Text("Login")
                    .font(.largeTitle)
                    .bold()
                ...
                // Add a spacer to align the content of the LoginScreen closer to the top
                Spacer()
            ...
            .toolbar {
                 ...
                 ToolbarItem(placement: .navigationBarTrailing) {
                     NavRightButton(destination: SignUpScreen(), buttonText: "Sign up")
                 }
            }
